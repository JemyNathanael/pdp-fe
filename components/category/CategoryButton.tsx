...
const defaultStyle = "bg-[#3788FD] text-white font-bold py-2 px-10 rounded";
const outlinedStyle = "bg-transparent border-2 border-[#3788FD] hover:bg-gray-200 text-[#3788FD] font-bold py-2 px-10 rounded";
